...
class ControllerExtensionModuleTagmanager extends Controller {
	...
	public function install() {
		...
		$this->model_setting_event->addEvent('tagmanager_head', 'catalog/view/common/header/after', 'extension/module/tagmanager/insert_head_code_after');
		$this->model_setting_event->addEvent('tagmanager_body', 'catalog/view/common/header/after', 'extension/module/tagmanager/insert_body_code_after');
	}
